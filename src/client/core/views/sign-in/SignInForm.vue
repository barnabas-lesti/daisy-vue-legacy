<template lang="pug">
  v-form.sign-in-form(
    ...
    v-text-field(
      ...
      name="email"
      type="email"
      data-qa="views.signIn.form.email"
    )
    v-text-field(
      ...
      name="password"
      type="password"
      data-qa="views.signIn.form.password"
    )
    .d-flex.mb-4.justify-end
      v-btn(
        ...
        color="primary"
        type="submit"
        data-qa="views.signIn.form.submit"
        large
        tile
    ...
    .d-flex
      router-link(
        :to={ name: 'register' }
        data-qa="views.signIn.form.registerLink"
