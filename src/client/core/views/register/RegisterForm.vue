<template lang="pug">
  v-form.register-form(
    ...
    v-text-field(
      ...
      name="password"
      type="password"
      data-qa="register.form.password"
    )
    v-text-field(
      ...
      type="password"
      data-qa="register.form.passwordConfirm"
    )
    ...
    .d-flex
      router-link(
        :to={ name: 'signIn' }
        data-qa="register.form.signInLink"
